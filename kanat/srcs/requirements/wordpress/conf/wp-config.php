...
define( 'FTP_USER', 'jkeitha' ); #most likely not necessary, can be entered in the web form as well
define( 'FTP_HOST', 'ftp:21' );
define( 'FTP_BASE', 'jkeitha' ); #the bind mounted directory to /var/www/wordpress, necessary b/c we chroot
define( 'FTP_CONTENT_DIR', '/jkeitha/wp-content/' ); #the *relative* path as seen after an sftp login
// define( 'FTP_PLUGIN_DIR ', '/jkeitha/wp-content/plugins/' ); #see above
...
define( 'DB_USER', 'jkeitha' );

/** Пароль к базе данных MySQL */
define( 'DB_PASSWORD', 'jkeitha' );
